...
putStrLn "--------------------------------------". create an off chain code for the working smart contract above without using lucid to properly test the smart contract from my terminal. all emulator tests and the necessary cabal modifications should be provided. note that the above smart contract fully compiles successfully
